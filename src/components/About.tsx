        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className={`space-y-8 ${isVisible ? 'hero-fade-in' : ''}`}>
            <div className="space-y-6">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold font-poppins text-[hsl(var(--hero-title))]">
                About Us
              </h2>
              
              <div className="space-y-6">
                <p className="text-lg lg:text-xl font-inter text-[hsl(var(--hero-subtitle))] leading-relaxed">
