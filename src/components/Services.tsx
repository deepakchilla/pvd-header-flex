            ...
            return (
              ...
              >
                ...
                <div className="space-y-4">
                  <h3 className="text-xl lg:text-2xl font-semibold font-poppins text-[hsl(var(--hero-title))] group-hover:text-[hsl(var(--accent))] transition-colors duration-300">
                    {service.title}
                  </h3>
                  <p className="text-base font-inter text-[hsl(var(--hero-subtitle))] leading-relaxed">
                    {service.description}
                  </p>
                </div>
